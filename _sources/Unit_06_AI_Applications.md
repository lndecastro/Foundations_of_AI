...
| **Control** | Choose actions over time | Robotics, autonomous navigation, production, autoscaling |
| **Recommendation and Personalization** | Find items of interest | Retail, social media, online apps, services |
| **Search and Optimization** | Find optimal solutions to problems | Logistics, packing, routing, scheduling | 

You have already built the first three yourself. The remaining are the ones you may be *using* rather than building for the rest of this course.
...
| Code vulnerability scanner | An engineer wastes time | A shipped exploit |

Same type of model (classifier) with radically different consequences. The spam filter can tolerate errors in either direction; the screening system cannot, and the *asymmetry* between its two error types is an important design problem.
...
- **Logistics and operations**: forecasting, routing, scheduling, maintenance prediction. Usually narrow AI and where much of the real economic value has accumulated.
